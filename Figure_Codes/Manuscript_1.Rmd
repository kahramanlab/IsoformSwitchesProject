...
tuPro_primary_tpm <- readRDS('/Users/admin/Desktop/TuPro_Paper/Codes/Codes_Figures/Data/NonRedundantTPMs/Ovary_OvarianCancer/tuPro_tpm_NR_primary.RDS')

tuPro_primary_tpm_redundant <- read.csv('/Users/admin/Desktop/TuPro_Paper/Codes/Codes_Figures/Data/NonRedundantTPMs/redundant.tsv', sep = '\t', header = TRUE, check.names = FALSE)

dim(tuPro_primary_tpm_redundant)[1] - dim(tuPro_primary_tpm)[1] # 507 first row in the redundant one is tpm
```
