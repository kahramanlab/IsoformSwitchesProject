...
# score 900
Iso_Iso_Network_v12 <- read.csv('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/Iso_Iso_Network/interactionsInIsoforms_400_2_status_withTitin_withoutWARNING.tsv', sep='\t', header = TRUE)
head(Iso_Iso_Network_v12)
```

```{r read_string_PPI}
string_PPI <- read.csv('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/Iso_Iso_Network/9606.protein.links.detailed.v12.0.txt', sep=' ', header = TRUE)
...
ov_tcga_tpm_NR <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/Ovary/TPMValues/RedundantTPMs/tcga_tpm_NR.RDS')
ov_tuPro_tpm_NR_primary <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/Ovary/TPMValues/RedundantTPMs/tuPro_tpm_NR_primary.RDS')
ov_tuPro_tpm_NR_metastatic <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/Ovary/TPMValues/RedundantTPMs/tuPro_tpm_NR_metastatic.RDS')
mel_tcga_primary_tpm_NR <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/Melanoma/TPMValues/RedundantTPMs/tcga_primary_tpm_NR.RDS')
mel_tcga_metastatic_tpm_NR <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/Melanoma/TPMValues/RedundantTPMs/tcga_metastatic_tpm_NR.RDS')
mel_tuPro_tpm_NR <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/Melanoma/TPMValues/RedundantTPMs/tuPro_tpm_NR.RDS')
AML_tcga_tpm_NR <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/AML/TPMValues/RedundantTPMs/tcga_tpm_NR.RDS')
AML_tuPro_tpm_NR <- readRDS('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/TumorProfiler/Analysis/May2024/AML/TPMValues/RedundantTPMs/tuPro_tpm_NR.RDS')
```
...
Switching_Events_Network_Ov_tcga <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_Ov_tcga, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = ov_tcga_tpm_NR, iso_network = Iso_Iso_Network_v12)
...
Switching_Events_Network_Ov_tuPro_primary <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_Ov_tuPro, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = ov_tuPro_tpm_NR_primary, iso_network = Iso_Iso_Network_v12)
...
Switching_Events_Network_Ov_tuPro_met <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_Ov_tuPro_met, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = ov_tuPro_tpm_NR_metastatic, iso_network = Iso_Iso_Network_v12)
...
Switching_Events_Network_Mel_tcga_Pri <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_Mel_tcga_pri, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = mel_tcga_primary_tpm_NR, iso_network = Iso_Iso_Network_v12)
...
Switching_Events_Network_Mel_tcga_met  <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_Mel_tcga_met, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = mel_tcga_metastatic_tpm_NR, iso_network = Iso_Iso_Network_v12)
...
Switching_Events_Network_Mel_tuPro_met  <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_Mel_tuPro_met, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = mel_tuPro_tpm_NR, iso_network = Iso_Iso_Network_v12)
...
Switching_Events_Network_AML_TCGA  <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_AML_TCGA, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = AML_tcga_tpm_NR, iso_network = Iso_Iso_Network_v12)
```
...
Switching_Events_Network_AML_TuPro  <- buildIsoNet2(dMDT_network_info = dMDTs_IsoNetwork_int_AML_TuPro, ensembl_data = ENSG_ENST_ENSP_Pfam, kallisto_counts = AML_tuPro_tpm_NR, iso_network = Iso_Iso_Network_v12)
```
...
```{r FunctionBuildIsoNet}

buildIsoNet2 <- function (dMDT_network_info, ensembl_data, iso_network, kallisto_counts) 
{
...
```
```{r codingseq}
ensg_enst_ensp_pdb_pfams <- read.csv('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/Drug_Isoform/mart_export.txt', sep='\t', header=TRUE)
...
```{r TKIlist}
TKI <- read.table('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/Drug_Isoform/DrugBank/TKI_Drugs_28052024.txt', header = TRUE, sep='\t')
head(TKI)
...
```{r readDrugNames}
drug_het_ids <- read.csv('/Volumes/PersonalDisk/PhD_Macbook/PhD/Projects/Drug_Isoform/DrugIsoformInt/Drug_Het_Ids.tsv', sep=',')
head(drug_het_ids)
```
